...
cpupnetwork <- subset(cpunetwork, Downloaded > 0)

png(filename="MaxBytesUsed.png", width=320, height=39, bg="transparent")
sparkline(max_space / (1024*1024), width=4, height=0.5)
dev.off()
svg(filename="MaxBytesUsed.svg", width=5, height=0.5, bg="transparent")
sparkline(max_space / (1024*1024), width=5, height=0.5)
dev.off()

png(filename="PeakMegabytes.png", width=320, height=39, bg="transparent")
sparkline(peak_alloc, width=4, height=0.5)
dev.off()
svg(filename="PeakMegabytes.svg", width=5, height=0.5, bg="transparent")
sparkline(peak_alloc, width=5, height=0.5)
dev.off()

png(filename="Productivity.png", width=320, height=39, bg="transparent")
sparkline(productivity, width=4, height=0.5)
dev.off()
svg(filename="Productivity.svg", width=5, height=0.5, bg="transparent")
sparkline(productivity, width=5, height=0.5)
dev.off()

png(filename="CPUNet.png", width=320, height=39, bg="transparent")
sparkline(cpupnetwork, width=4, height=0.5)
dev.off()
svg(filename="CPUNet.svg", width=5, height=0.5, bg="transparent")
sparkline(cpupnetwork, width=5, height=0.5)
dev.off()
