...
# sigfigs = number of significant figures to round min, max, and last values to
        ...
        par(mai=c(0.0,0.05,0.0,0.05),fin=c(width,height))
...
png(filename="MaxBytesUsed.png", width=125, height=39)
sparkline(max_space / (1024*1024), width=1.5, height=0.50)
dev.off()
png(filename="PeakMegabytes.png", width=125, height=39)
sparkline(peak_alloc, width=1.5, height=0.5)
dev.off()
