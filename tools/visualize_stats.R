...
max_space <- subset(MaxBytesUsed, MaxBytesUsed < (300*1024*1024))
peak_alloc <- subset(PeakMegabytesAlloc, PeakMegabytesAlloc < 400)
cpupnetwork <- subset(cpupnetwork, cpupnetwork < 3)
